...
def get_book() -> Book:
    return Book(
        ...
        TwoPageTemplateSpread(
            TwoPagePhotoTemplate(Photo('https://unsplash.com/photos/GlQBrIRmaJg/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8OHx8bG9uZG9uJTIwcGFub3JhbWljfGVufDB8fHx8MTcyMzgxNTMwOHww&force=true&w=640'))
        )
    )
